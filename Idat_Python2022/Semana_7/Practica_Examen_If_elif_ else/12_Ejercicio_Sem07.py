...
# entonces la base y la altura y escribir el área. Si se contesta que se quiere calcular el área de
# un círculo (escribiendo C o c), el programa tiene que pedir entonces el radio y escribir el área.

# Se recuerda que el área de un triángulo es base por altura dividido por 2 y que el área de un
# círculo es Pi (aproximadamente 3,141592) por el radio al cuadrado.
